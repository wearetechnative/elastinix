# Documenso Administration Guide

Complete guide for deploying and managing [Documenso](https://github.com/documenso/documenso) - the open-source DocuSign alternative on NixOS.
...
This module follows NixOS module conventions. See `modules/nixos/services/documenso/default.nix` for implementation.
