...
in {
  ...
  age.identityPaths = [ "/tmp/system_sshd_key" ];

  age.secrets.psql_backup_database = {
    file = ../../../stack/ec2_compute1/secrets/psql_backup_database_${infra_environment}.age;
    owner = "root";
    group = "root";
    path = "/run/secrets/psql_backup_database.env";
    mode = "0660";
  };
  ...
  systemd.services."${infra_environment}-psql-backup" =
      ...
      script = ''
        ...
        config_files=("/run/secrets/psql_backup_database.env")
