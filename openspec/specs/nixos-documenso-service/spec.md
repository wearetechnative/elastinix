# Capability: nixos-documenso-service

## Purpose

This capability provides a NixOS service module for running Documenso, an open-source document signing platform. It handles service configuration, dependency management (including Playwright browser compatibility), secure certificate generation for PDF signing, and S3 storage integration.
